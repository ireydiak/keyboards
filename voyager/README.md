...
This README.md was taken from the official [ZSA QMK fork](https://github.com/zsa/qmk_firmware).
To build my keymap, use the following command from the current directory.
...
Good luck on your journey! And remember, if you get stuck, you can always get back to your [original layout](https://configure.zsa.io/voyager/layouts/E5AmY/6KNmB/0) from Oryx.
